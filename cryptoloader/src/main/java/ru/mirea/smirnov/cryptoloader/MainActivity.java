...
import ru.mirea.smirnov.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private final int LoaderID = 2345;
        ...
        public void onClickButton(View view) {
            ...
            bundle.putByteArray(NotMyLoader.ARG_WORD, encryptMsg());
        ...
        public Loader<String> onCreateLoader(int i, @Nullable Bundle bundle) {
            if (i == LoaderID) {
                ...
                return new NotMyLoader(this, bundle);
            }
