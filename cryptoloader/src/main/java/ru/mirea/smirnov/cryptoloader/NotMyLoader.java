package ru.mirea.smirnov.cryptoloader;
...
public class NotMyLoader extends AsyncTaskLoader<String> {
    byte[] cryptText;
    ...
    public static final String ARG_WORD = "Smirnov";

    public NotMyLoader(@NonNull Context context, Bundle args) {
        super(context);
        if (args != null)
        {
    ...
    public String loadInBackground() {
        ...
        return String.format("Расшифровка сообщения: %s",decryptMsg());
    }
}
